...
/**
 * Automatically generated Parcelable implementation for _HashtagEntity.
 * DO NOT MODIFY THIS FILE MANUALLY! IT WILL BE OVERWRITTEN THE NEXT TIME
 * _HashtagEntity's PARCELABLE DESCRIPTION IS CHANGED.
 */
/* package */ abstract class _HashtagEntity implements Parcelable {

  protected List<Integer> mIndices;
  protected String mText;

  protected _HashtagEntity(List<Integer> indices, String text) {
    this();
    mIndices = indices;
    mText = text;
  }

  protected _HashtagEntity() {
    super();
  }
  ...
  public boolean equals(Object object) {
    ...
    _HashtagEntity that = (_HashtagEntity) object;
